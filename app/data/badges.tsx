...
export const badges: Badge[] = [
  ...
  { name: "fée", icon: "fairy.png", obtention: false },
  { name: "combat", icon: "fighting.png", obtention: true },
  { name: "feu", icon: "fire.png", obtention: false },
  ...
  { name: "roche", icon: "rock.png", obtention: false },
  { name: "acier", icon: "steel.png", obtention: false },
