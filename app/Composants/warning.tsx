...
import { HackTerminal } from "./hacking";
...
export function LevelWarning() {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 bottom-0 z-[5000] bg-black/40 flex items-center justify-center">
      ...
      {showHack && (
        <HackTerminal onClose={() => setShowHack(false)} onSuccess={() => { setShowHack(false); setBypassed(true); }} />
      )}
